...
│ approval.py  слой полит. риска │ │ офлайн-шаблоны (narrative.py)  │
│ shock.py     кризисы           │ └────────────────────────────────┘
└──────────────┬─────────────────┘
...
api/agent.py               агент, провайдеры, ограничитель чисел
api/prompts.py             системные промпты (RU)
api/narrative.py           офлайн-шаблоны: анализ, Совет районов, газета
