...
- No live presentation: judges evaluate the repository only. QR/live audience rooms dropped (rooms commit reverted); priority goes to what a judge sees on clone-and-run: README, reproducibility, verifiable correctness, the AI analysis.
